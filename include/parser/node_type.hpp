/**
 * @brief c style node_type enumeration
 * @todo enum class replace
 */

#pragma once
#ifndef PRASER_NODE_TYPE_H
#define PRASER_NODE_TYPE_H
...
// typedef enum _node_type node_type; // defined in ast.h

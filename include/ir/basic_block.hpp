...
class BasicBlock : public Value, public std::enable_shared_from_this<BasicBlock> {
    ...
    friend void linkBB(const std::shared_ptr<BasicBlock> &prebb, const std::shared_ptr<BasicBlock> &nxtbb);
    friend void unlinkBB(const std::shared_ptr<BasicBlock> &prebb, const std::shared_ptr<BasicBlock> &nxtbb);

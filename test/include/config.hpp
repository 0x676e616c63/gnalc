...
static const std::string gcc_arm_command = "aarch64-linux-gnu-gcc --sysroot=/usr/aarch64-redhat-linux/sys-root/fc42";
static const std::string qemu_arm_command =
    "qemu-aarch64 -cpu cortex-a53 -L /usr/aarch64-redhat-linux/sys-root/fc42/usr/";
// static const std::string qemu_arm_command = "LD_LIBRARY_PATH=/usr/arm-linux-gnueabihf/lib qemu-arm";
